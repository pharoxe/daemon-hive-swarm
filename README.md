...
**Landing site:** [daemon-agent-blond.vercel.app](https://daemon-agent-blond.vercel.app)

---

## QVAC submission artifacts

| Requirement | Location |
| --- | --- |
| Remote APIs (structured) | [`docs/REMOTE_APIS.md`](docs/REMOTE_APIS.md) |
| Inference audit log (one demo run) | [`docs/demo-audit-log.jsonl`](docs/demo-audit-log.jsonl) |
| Audit log schema + capture steps | [`docs/INFERENCE_AUDIT_LOG.md`](docs/INFERENCE_AUDIT_LOG.md) |

Local demo path uses on-device QVAC only. Remote APIs are optional (cloud keys, onchain/web tools, model downloads, Hive P2P).
...
├── docs/                   # QVAC submission: remote APIs, inference audit log
